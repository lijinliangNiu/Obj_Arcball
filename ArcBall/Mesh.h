...
public:
    ...
    /*  Functions  */
    // constructor
    Mesh(vector<objl::Vertex> vertices, vector<unsigned int> indices){
...
private:
    ...
    void setupMesh(){
        ...
        glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(objl::Vertex), (void*)offsetof(objl::Vertex, TexCoords));
